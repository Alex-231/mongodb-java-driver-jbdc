...
public class MongoDatabase implements com.mongodb.client.MongoDatabase {
    ...
    protected MongoDatabase(final String name, final CodecRegistry codecRegistry, final ReadPreference readPreference,
    ...
    public MongoDatabase withCodecRegistry(final CodecRegistry codecRegistry) {
        return new MongoDatabase(name, codecRegistry, readPreference, writeConcern, readConcern, executor);
    }
    ...
    public <TDocument> MongoCollection<TDocument> getCollection(final String collectionName, final Class<TDocument> documentClass) {
        return new MongoCollectionImpl<TDocument>(new MongoNamespace(name, collectionName), documentClass, codecRegistry, readPreference,
                                                  writeConcern, true, readConcern, (com.mongodb.OperationExecutor) executor);
    }
    ...
    private <TResult> TResult executeCommand(final ClientSession clientSession, final Bson command, final ReadPreference readPreference,
        ...
        return executor.execute(new CommandReadOperation<TResult>(getName(), toBsonDocument(command), codecRegistry.get(resultClass)), readPreference);
    }
    ...
    private <TResult> ListCollectionsIterable<TResult> executeListCollections(final ClientSession clientSession, final Class<TResult> resultClass) {
        return new ListCollectionsIterableImpl<TResult>(clientSession, name, resultClass, codecRegistry, ReadPreference.primary(), (com.mongodb.OperationExecutor) executor);
    }
